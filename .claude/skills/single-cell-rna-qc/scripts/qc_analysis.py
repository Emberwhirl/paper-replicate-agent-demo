...
print(f"  Gene patterns: Using uppercase matching (MT-, RPS/RPL, HB)")
...
print(f"  Found {adata.var['mt'].sum()} mitochondrial genes (MT-)")
print(f"  Found {adata.var['ribo'].sum()} ribosomal genes (RPS/RPL)")
print(f"  Found {adata.var['hb'].sum()} hemoglobin genes (HB)")
